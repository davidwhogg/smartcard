...
spacecraft temperature issues, stellar abberation, parallax, and proper motion,
...
$10^{-4}$ to $10^{-5}$ level.
Most of these effects lead to smooth light-curve variations, but in addition
there are also discontinuities at the \Kepler\ quarter boundaries (when the
spacecraft attitude is re-set) and in addition, poorly understood Sudden Pixel
...
We propose to release a implementation of version~0.1 of \Untrendy\ as a standalone C
