...
% to-do
% -----
% - issue: thread radial velocity arguments throughout
% - issue close: kplr upgrades
% - issue: ``install'' comments for each component (except TheCreator)
% - issue close: emcee in intro
% - issue: get all citations in for the introduction
% - outline
% - write
% - submit
% - spend
...
\newcommand{\EA}{\project{Exoplanet Archive}}
...
The official source of Kepler data is the \project{Mikulski Archive for Space
...
in the \Kepler\ field.
Another catalog of exoplanet parameters is the \project{NASA Exoplanet Archive}%
...
stack---especially \package{AstroPy} (http://www.astropy.org/) which incentivize this adoption.
Python has many tools---such as \package{iPython} (http://ipython.org/)
...
\footnote{https://github.com/dfm/kplr},
...
Complete and release version~1.0 of \kplr\ API along with complete documentation.
Release version~0.1
of \Untrendy, \Turnstile, and \Bart, executing the first stages of
approximation identified above, plus complete documentation.  Submit short papers describing these
...
described above, along with documentation.
...
features to \Bart.
Complete and release Version~0.2 code for these packages, along with complete documentation.
If the \MAST\ \Kepler\ data have changed or new relevant data sources have appeared, upgrade and release version~1.1 of \kplr.
Start side projects on stellar variability, eclipsing
...
side projects and submit papers.
Make final decisions about final code versions, final code adjustments, documentation, and hosting.
Again, if the \MAST\ \Kepler\ data have changed or new relevant data sources have appeared, upgrade and release version~1.2 of \kplr.
...
\TheCreator, along with documentation and also (possibly very short) papers on arXiv or ASCL.
