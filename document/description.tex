...
samples for the physical parameters of the planet: semi-major axis $a$, radius
...
Finally, after applying the survey systematics $S$, the observations
$\mathbf{X}_n$---light curves, radial velocities, etc.---are noisily drawn by
