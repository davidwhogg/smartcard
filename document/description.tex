...
One key idea for both population modeling and for uptake by the community

HOGG:  Key idea: User can choose parameterization...

\paragraph{Enhanced goals:}
False positive detection using LD discrepancies.  CITE BLENDER

Sampling over model complexity.

Astrometric exoplanets.  \Gaia plans to release astrometry residuals on stars and binaries and stars+exoplanets.

\paragraph{Proposal:}
\textit{Our proposal is to release a complete, flexible package for
...
make use of forthcoming \Gaia\ astrometric data.
...
As a result, these studies are required to be extremely conservative in their
